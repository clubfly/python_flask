...
def vcms_company_profile(self,functions,actions,html_template,page_settings,parameter_dict):
    if session["user_rank_sn"] == 2 :
        return VcmsRootFunction().get_company_profile_list(page_settings,int(parameter_dict.get("data_sn")))
    return ""
