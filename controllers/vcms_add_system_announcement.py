...
def vcms_add_system_announcement(self,functions,actions,html_template,page_settings,parameter_dict):
    return_data = {}
    if session["user_rank_sn"] == 2 :
        return_data = VcmsRootFunction().get_edit_system_announcement(page_settings,parameter_dict)
