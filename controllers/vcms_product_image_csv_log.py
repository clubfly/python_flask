...
def vcms_product_image_csv_log(self,functions,actions,html_template,page_settings,parameter_dict) :
    ...
    if session["user_rank_sn"] == 3 :
        return VcmsAdminFunction().get_product_image_csv_log_list(page_settings,int(parameter_dict.get("data_sn")))
