...
def vcms_admin_batch_product(self,functions,actions,html_template,page_settings,parameter_dict) :
    ...
    if session["user_rank_sn"] == 3 :
        return VcmsAdminFunction().get_company_batch_product_list(page_settings,int(parameter_dict.get("data_sn")))
