...
def vcms_company_branch_account(self,functions,actions,html_template,page_settings,parameter_dict):
    if session["user_rank_sn"] == 3 :
        return VcmsAdminFunction().get_company_branch_account_list(page_settings,int(parameter_dict.get("data_sn")))
    return ""
