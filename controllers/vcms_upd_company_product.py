...
def vcms_upd_company_product(self,functions,actions,html_template,page_settings,parameter_dict):
    return_data = {}
    if session["user_rank_sn"] == 3 :
        return_data = VcmsAdminFunction().set_company_product(page_settings,parameter_dict,request.files)
