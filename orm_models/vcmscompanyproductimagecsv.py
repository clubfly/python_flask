...
class VcmsCompanyProductImageCsv(Base):
    __tablename__ = 'company_product_image_csv'
    ...
    zip_user_file_name = Column(String, nullable=True)
    zip_sys_file_name = Column(String, nullable=True)
    zip_manage_mark = Column(Integer, default=0)
    zip_manage_time = Column(DateTime, nullable=True)
    ...
    def __init__(self,company_sn = 0,
                      ...
                      ut = None,
                      deprecated = 0,
                      zip_user_file_name=None,
                      zip_sys_file_name=None,
                      zip_manage_mark = 0,
                      zip_manage_time = None) :
        ...
        self.zip_user_file_name = zip_user_file_name
        self.zip_sys_file_name = zip_sys_file_name
        self.zip_manage_mark = zip_manage_mark
        self.zip_manage_time = zip_manage_time
